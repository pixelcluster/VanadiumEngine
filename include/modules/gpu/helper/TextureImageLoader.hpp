...
VImageResourceHandle loadTexture(const char* filename, VGPUResourceAllocator* allocator,
								 VGPUTransferManager* transferManager, VkImageUsageFlags usageFlags,
	...
	VImageResourceHandle handle = allocator->createImage(imageCreateInfo, {}, { .deviceLocal = true });
	...
	transferManager->submitImageTransfer(handle,
										 { .imageSubresource = { .aspectMask = VK_IMAGE_ASPECT_COLOR_BIT,
										   ...
										   .imageExtent = { .width = static_cast<uint32_t>(imageWidth),
															.height = static_cast<uint32_t>(imageHeight),
															.depth = 1U } },
										 data, imageWidth * imageHeight * 4, usingStageFlags,
										 usingAccessFlags, usingImageLayout);

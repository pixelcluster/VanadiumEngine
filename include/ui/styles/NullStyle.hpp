...
namespace vanadium::ui::styles {
	struct NullStyle {
		...
		static std::vector<Shape*> createShapes(UISubsystem* subsystem, const Vector2& position, const Vector2& size,
												const StyleParameters& parameters) {
			return {};
		}
		static void repositionShapes(UISubsystem* subsystem, const Vector2& position, const Vector2& size,

...
uint32_t PipelineInstanceRecord::asUIntOr(const Json::Value& value, const std::string_view& name, uint32_t fallback) {
...
bool PipelineInstanceRecord::asBoolOr(const Json::Value& value, const std::string_view& name, bool fallback) {
...
const char* PipelineInstanceRecord::asCStringOr(const Json::Value& value, const std::string_view& name,
												const char* fallback) {
...
std::string PipelineInstanceRecord::asStringOr(const Json::Value& value, const std::string_view& name,
...
float PipelineInstanceRecord::asFloatOr(const Json::Value& value, const std::string_view& name, float fallback) {
